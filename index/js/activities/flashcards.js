      ...
      var root = U.el(
        '<section class="fc" aria-label="Flashcards">' +
            ...
            '<div class="fc-card" tabindex="0" role="button" aria-pressed="false">' +
              '<div class="fc-card__inner">' +
                '<div class="fc-card__face fc-card__face--front">' +
                  ...
                  '<span class="fc-card__verdict fc-card__verdict--got">' + Icon('check') + 'Got it</span>' +
                  '<span class="fc-card__verdict fc-card__verdict--still">' + Icon('replay') + 'Again</span>' +
          ...
          '<div class="fc-actions">' +
            '<button type="button" class="btn btn--outline-edit fc-rate fc-rate--still">' +
              '<span class="rate-icon rate-icon--left" aria-hidden="true">&#8592;</span>Still learning</button>' +
            '<button type="button" class="btn btn--ok fc-rate fc-rate--got">' +
