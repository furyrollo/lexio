...
(function (global) {
  ...
  var P = {
    ...
    sparkles:  '<path d="m12 4 1.6 4.4L18 10l-4.4 1.6L12 16l-1.6-4.4L6 10l4.4-1.6L12 4Z"/><path d="M18.5 15.5 19 17.3l1.8.7-1.8.7-.5 1.8-.5-1.8-1.8-.7 1.8-.7.5-1.8Z"/><path d="M5 16.5 5.5 18l1.5.5-1.5.5L5 20.5 4.5 19 3 18.5 4.5 18 5 16.5Z"/>',
    ring:      '<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="4.5"/>',
    shield_check: '<path d="M12 21c4.5-1.8 7-5.2 7-9.6V5.8L12 3 5 5.8v5.6c0 4.4 2.5 7.8 7 9.6Z"/><path d="m9 11.8 2.2 2.2L15 10"/>',
    cloud_check: '<path d="M7 18.5a4.5 4.5 0 0 1-.4-9A5.5 5.5 0 0 1 17 8.3a4 4 0 0 1 .3 8Z"/><path d="m9.8 13.2 2.2 2.2 3.7-4.4"/>',
    monitor:   '<rect x="3" y="4.5" width="18" height="12" rx="2.5"/><path d="M9 20.5h6M12 16.5v4"/>',
    check_circle: '<circle cx="12" cy="12" r="9"/><path d="m8.5 12.5 2.5 2.5 4.5-5.5"/>',
    x_circle:  '<circle cx="12" cy="12" r="9"/><path d="m9 9 6 6M15 9l-6 6"/>',
    keyboard:  '<rect x="2.5" y="6" width="19" height="12" rx="2.5"/><path d="M6 10.5h.01M10 10.5h.01M14 10.5h.01M18 10.5h.01M6 14h.01M18 14h.01M8.5 14h7"/>'
  };
